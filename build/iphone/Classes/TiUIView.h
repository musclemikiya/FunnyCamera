...
/**
 Base class for all FunnyCamera views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FunnyCamera view hierarchy (such as wrapped iOS UIViews) was touched.
