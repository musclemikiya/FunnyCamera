...
// in simulator we redefine to format for FunnyCamera Developer console
...
{\
	NSString * exceptionName = [@"org.funnycamera." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.funnycamera";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFunnyCameraNativeItemNone = -1, 
	UIFunnyCameraNativeItemSpinner = -2,
	UIFunnyCameraNativeItemProgressBar = -3,
	
	UIFunnyCameraNativeItemSlider = -4,
	UIFunnyCameraNativeItemSwitch = -5,
	UIFunnyCameraNativeItemMultiButton = -6,
	UIFunnyCameraNativeItemSegmented = -7,
	
	UIFunnyCameraNativeItemTextView = -8,
	UIFunnyCameraNativeItemTextField = -9,
	UIFunnyCameraNativeItemSearchBar = -10,
	
	UIFunnyCameraNativeItemPicker = -11,
	UIFunnyCameraNativeItemDatePicker = -12,
	
	UIFunnyCameraNativeItemInfoLight = -13,
	UIFunnyCameraNativeItemInfoDark = -14,
	
	UIFunnyCameraNativeItemDisclosure = -15,
	
	UIFunnyCameraNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FunnyCamera instances of
