 ...
 * Copyright (c) 2009-2011 by FunnyCamera, Inc. All Rights Reserved.
...
//@interface FunnyCameraObject : NSObject
//@end

@interface FunnyCameraObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FunnyCameraObject class]])
		{
			for (NSString *key in [[(FunnyCameraObject*)o modules] allKeys])
			{
