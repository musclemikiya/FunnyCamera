...
@interface FunnyCameraObject : KrollCoverageObject {
#else
@interface FunnyCameraObject : KrollObject {
#endif
@private
...
extern NSString * FunnyCamera$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FunnyCameraObject *_funnycamera;
    KrollObject* console;
	BOOL shutdown;
